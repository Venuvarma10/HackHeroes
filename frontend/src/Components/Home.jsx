    ...
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <div className="flex items-center justify-center w-[100%]  absolute bottom-9 p-20">
        <div className="w-[50%] text-white m-3">
            ...
            <p className="text-[16px]">EcoFin AI is an advanced AI-driven platform designed to help financial institutions evaluate, prioritize, and optimize sustainable investments. By leveraging AI-powered risk ratings, ESG analysis, and real-time insights, it enables smarter decision-making for green finance allocation.</p>
            
            <button className="border px-20  py-6 rounded-[15px] cursor-pointer bg-blue-700 border-none mt-20"><NavLink to={'/investmentsubmission'}>Get Started</NavLink></button>
