...
def suggestions(risk,esg,priority,capital):
    ...
    response = client.models.generate_content(
        model="gemini-2.0-flash", contents="""riskfactor{risk},ESG{Given a set of green finance investment projects, evaluate and recommend the best projects based on the following criteria:
